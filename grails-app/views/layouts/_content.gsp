            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-sm-6 col-lg-6">
                        ...
                        <p><strong>Meliore inciderint qui ne. Suas cotidieque vel ut lobortis reformidans duo</strong>
                        </p>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-6">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#one" data-toggle="tab"><i class="icon-briefcase"></i> One</a>
                            </li>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="one">
                                <p><asset:image src="img/dummy1.jpg" class="pull-left"/>
                            ...
                            <div class="tab-pane" id="two">
                                <p>
                                    <asset:image src="img/dummy1.jpg" class="pull-right"/>
                                    Tale dolor mea ex, te enim assum suscipit cum, vix aliquid omittantur in. Duo eu cibo dolorum menandri, nam sumo dicit admodum ei. Ne mazim commune honestatis cum, mentitum phaedrum sit
                                    et.
                                </p>
                ...
                <div id="grid-container" class="cbp-l-grid-projects">
                    <ul>
                        <li class="cbp-item graphic">
                            <div class="cbp-caption">
                                <div class="cbp-caption-defaultWrap">
                                    <asset:image src="img/works/1.jpg"/>
                                </div>

                                <div class="cbp-caption-activeWrap">
                                    <div class="cbp-l-caption-alignCenter">
                                        <div class="cbp-l-caption-body">
                                            <a href="img/works/1big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight"
                        ...
                        <li class="cbp-item web-design logo">
                            <div class="cbp-caption">
                                <div class="cbp-caption-defaultWrap">
                                    <asset:image src="img/works/2.jpg"/>
                                </div>

                                <div class="cbp-caption-activeWrap">
                                    <div class="cbp-l-caption-alignCenter">
                                        <div class="cbp-l-caption-body">
                                            <a href="img/works/2big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight"
                        ...
                        <li class="cbp-item graphic logo">
                            <div class="cbp-caption">
                                <div class="cbp-caption-defaultWrap">
                                    <asset:image src="img/works/3.jpg"/>
                                </div>
                        ...
                        <li class="cbp-item web-design graphic">
                            <div class="cbp-caption">
                                <div class="cbp-caption-defaultWrap">
                                    <asset:image src="img/works/4.jpg"/>
                                </div>
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="cbp-l-caption-alignCenter">
                                        <div class="cbp-l-caption-body">
                                            ...
                                            <a href="img/works/4big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight"
                        ...
                        <li class="cbp-item identity web-design">
                            <div class="cbp-caption">
                                <div class="cbp-caption-defaultWrap">
                                    <asset:image src="img/works/5.jpg"/>
                                </div>
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="cbp-l-caption-alignCenter">
                                        <div class="cbp-l-caption-body">
                                            ...
                                            <a href="img/works/5big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight"
                        ...
                        <li class="cbp-item identity web-design">
                            <div class="cbp-caption">
                                <div class="cbp-caption-defaultWrap">
                                    <asset:image src="img/works/6.jpg"/>
                                </div>
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="cbp-l-caption-alignCenter">
                                        <div class="cbp-l-caption-body">
                                            ...
                                            <a href="img/works/6big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight"
                        ...
                        <li class="cbp-item graphic logo">
                            <div class="cbp-caption">
                                <div class="cbp-caption-defaultWrap">
                                    <asset:image src="img/works/7.jpg"/>
                                </div>
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="cbp-l-caption-alignCenter">
                                        <div class="cbp-l-caption-body">
                                            ...
                                            <a href="img/works/7big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight"
                        ...
                        <li class="cbp-item graphic logo">
                            <div class="cbp-caption">
                                <div class="cbp-caption-defaultWrap">
                                    <asset:image src="img/works/8.jpg"/>
                                </div>
                                ...
                                <div class="cbp-caption-activeWrap">
                                    <div class="cbp-l-caption-alignCenter">
                                        <div class="cbp-l-caption-body">
                                            ...
                                            <a href="img/works/8big.jpg" class="cbp-lightbox cbp-l-caption-buttonRight"
                                               data-title="Seemple* Music for iPad<br>by Tiberiu Neamu">view larger</a>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-6 col-md-2 aligncenter client">
                <asset:image src="img/clients/logo1.png" class="img-responsive"/>
            </div>

            <div class="col-xs-6 col-md-2 aligncenter client">
                <asset:image src="img/clients/logo2.png" class="img-responsive"/>
            </div>

            <div class="col-xs-6 col-md-2 aligncenter client">
                <asset:image src="img/clients/logo3.png" class="img-responsive"/>
            </div>

            <div class="col-xs-6 col-md-2 aligncenter client">
                <asset:image src="img/clients/logo4.png" class="img-responsive"/>
            </div>

            <div class="col-xs-6 col-md-2 aligncenter client">
                <asset:image src="img/clients/logo5.png" class="img-responsive"/>
            </div>

            <div class="col-xs-6 col-md-2 aligncenter client">
                <asset:image src="img/clients/logo6.png" class="img-responsive"/>
            </div>
